...
# image = cv2.imread(r'C:\Users\Administrator\Music\CenterNet\COCO_train2014_000000461445.jpg')
# new_height,new_width,_ = image.shape
# new_center = np.array([new_height // 2, new_width // 2])
# inp_height = new_height | 127
# inp_width = new_width | 127
# resized_image, border, offset = crop_image(image, new_center, [inp_height, inp_width])
